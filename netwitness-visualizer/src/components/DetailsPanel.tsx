...
import { X, Globe, Shield, Database } from "lucide-react";
...
export default function DetailsPanel({
  ...
  return (
    <div className="absolute right-4 top-4 bottom-4 w-80 max-w-[calc(100vw-2rem)] bg-white dark:bg-gray-900 shadow-xl rounded-xl border border-gray-200 dark:border-gray-800 flex flex-col overflow-hidden z-10 transition-colors duration-200">
    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <div className="mt-1 font-mono text-sm text-[#BE3B37] dark:text-cyan-400 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 p-2 rounded-md transition-colors duration-200">
            {node.attrValue}
          </div>
        </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              {Array.from(relatedNodes).map(id => (
                <div 
                  key={id} 
                  className="font-mono text-xs text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 p-2 rounded transition-colors duration-200 cursor-pointer hover:bg-[#BE3B37]/10 dark:hover:bg-cyan-900/30 hover:border-[#BE3B37]/30 dark:hover:border-cyan-500"
                  onClick={() => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-gray-50 dark:bg-gray-800/50 p-3 rounded-lg border border-gray-200 dark:border-gray-700 transition-colors duration-200">
        ...
        {node.networkType && (
          <div className="bg-gray-50 dark:bg-gray-800/50 p-3 rounded-lg border border-gray-200 dark:border-gray-700 transition-colors duration-200">
            ...
            <div className={`text-sm font-semibold capitalize ${
              ...
              node.networkType === 'internal' ? 'text-blue-600 dark:text-sky-400' : 'text-gray-700 dark:text-gray-300'
            }`}>
              {node.networkType}
            </div>
          </div>
        ...
        {node.networkType === 'internal' && node.netname && (
          <div className="bg-gray-50 dark:bg-gray-800/50 p-3 rounded-lg border border-gray-200 dark:border-gray-700 transition-colors duration-200">
            ...
            <div className="text-sm font-semibold text-gray-700 dark:text-gray-300 truncate" title={node.netname}>
              {node.netname}
            </div>
          </div>
        )}
        {node.networkType !== 'internal' && node.country && (
          <div 
            className="bg-gray-50 dark:bg-gray-800/50 p-3 rounded-lg border border-gray-200 dark:border-gray-700 transition-colors duration-200 cursor-pointer hover:bg-[#BE3B37]/10 dark:hover:bg-cyan-900/30 hover:border-[#BE3B37]/30 dark:hover:border-cyan-500"
        ...
        {node.org && (
          ...
          >
            ...
            <div className="text-sm font-semibold text-gray-700 dark:text-gray-300 truncate" title={node.org}>
              {node.org}
            </div>
          </div>
        )}
              ...
              <div key={key}>
                ...
                <div className="mt-1 space-y-1">
                  {values.map((val, idx) => (
                    <div
                      key={idx}
                      className="font-mono text-xs text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 p-1.5 rounded break-all cursor-pointer hover:bg-[#BE3B37]/10 dark:hover:bg-cyan-900/30 hover:border-[#BE3B37]/30 dark:hover:border-cyan-500 transition-colors"
                      onClick={() => {
    ...
    <div className="space-y-6">
      <div className="space-y-2">
        <div>
          ...
          <div 
            className="mt-1 font-mono text-sm text-[#BE3B37] dark:text-cyan-400 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 p-2 rounded-md transition-colors duration-200 cursor-pointer hover:bg-[#BE3B37]/10 dark:hover:bg-cyan-900/30 hover:border-[#BE3B37]/30 dark:hover:border-cyan-500"
            onClick={() => {
                  ...
                  {Object.entries(session)
                    ...
                    .map(([key, value]) => (
                      <React.Fragment key={key}>
                        <div className="text-gray-500 truncate" title={key}>
                          {key}:
                        </div>
                        <div
